...
import "../evc/interfaces/IIRM.sol";
import "../evc/interfaces/IPriceOracle.sol";
...
contract VaultRegularBorrowable is VaultSimple {
    ...
    function liquidate(address violator, address collateral, uint256 repayAssets)
        external
        callThroughEVC
        nonReentrant
    {
    ...
    function _calculateAssetsToSeize(address violator, address collateral, uint256 repayAssets)
        internal
        view
        returns (uint256)
    {
