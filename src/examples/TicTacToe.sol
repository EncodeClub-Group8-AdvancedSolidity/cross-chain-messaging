...
contract TicTacToe {
    ...
    function acceptGame(Identifier calldata _newGameId, bytes calldata _newGameData) external {
        ...
        ICrossL2Inbox(PredeployAddresses.CROSS_L2_INBOX).validateMessage(_newGameId, keccak256(_newGameData));
        ...
        external
    {
        ...
        ICrossL2Inbox(PredeployAddresses.CROSS_L2_INBOX).validateMessage(_acceptedGameId, keccak256(_acceptedGameData));
    ...
    function makeMove(Identifier calldata _movePlayedId, bytes calldata _movePlayedData, uint8 _x, uint8 _y) external {
        ...
        ICrossL2Inbox(PredeployAddresses.CROSS_L2_INBOX).validateMessage(_movePlayedId, keccak256(_movePlayedData));
